...
=== 멘티 이력서 조회
**Request**
include::{snippets}/user/mentee/mypage/resume/http-request.adoc[]
include::{snippets}/user/mentee/mypage/resume/path-parameters.adoc[]

**Response**
include::{snippets}/user/mentee/mypage/resume/http-response.adoc[]
include::{snippets}/user/mentee/mypage/resume/response-fields.adoc[]
