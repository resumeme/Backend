...
=== 이력서 어학성적 조회
*Request*
include::{snippets}/foreignLanguage/find/http-request.adoc[]

*Response*
include::{snippets}/foreignLanguage/find/http-response.adoc[]
include::{snippets}/foreignLanguage/find/response-fields.adoc[]
...
=== 이력서 활동사항 조회
*Request*
include::{snippets}/activity/find/http-request.adoc[]

*Response*
include::{snippets}/activity/find/http-response.adoc[]
include::{snippets}/activity/find/response-fields.adoc[]
