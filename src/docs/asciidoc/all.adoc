...
=== 이력서 참고링크 수정
*Request*
include::{snippets}/resume/link/find/http-request.adoc[]

*Response*
include::{snippets}/resume/link/find/http-response.adoc[]
include::{snippets}/resume/link/find/response-fields.adoc[]
