...
=== 이력서 어학성적 조회
*Request*
include::{snippets}/resume/component/find/foreign-languages/http-request.adoc[]
include::{snippets}/resume/component/find/foreign-languages/path-parameters.adoc[]

*Response*
include::{snippets}/resume/component/find/foreign-languages/http-response.adoc[]
include::{snippets}/resume/component/find/foreign-languages/response-fields.adoc[]
...
=== 이력서 메모 조회
*Request*
include::{snippets}/resume/findMemo/http-request.adoc[]
include::{snippets}/resume/findMemo/path-parameters.adoc[]

*Response*
include::{snippets}/resume/findMemo/http-response.adoc[]
include::{snippets}/resume/findMemo/response-fields.adoc[]
