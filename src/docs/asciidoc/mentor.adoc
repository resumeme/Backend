...
include::{snippets}/event/completeReview/request-fields.adoc[]
...
*Request*
include::{snippets}/event/findOverallReview/http-request.adoc[]
include::{snippets}/event/findOverallReview/path-parameters.adoc[]


*Response*
include::{snippets}/event/findOverallReview/http-response.adoc[]
