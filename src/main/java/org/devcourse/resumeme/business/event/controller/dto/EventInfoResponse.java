...
public record EventInfoResponse(String title, String content, int maximumCount, int currentApplicantCount, String status, List<String> positions, TimeInfo timeInfo) {
